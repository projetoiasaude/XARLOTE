  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <Card href="/simulator" icon={<Zap className="text-yellow-400" />} title="Simulador WhatsApp" desc="Teste a Sara sem precisar do uazapi. Envie mensagens, imagens e localização." cta="Abrir simulador" color="yellow" />
      ...
      <div className="bg-wa-panel border border-wa-border rounded-xl p-6">
        ...
        <ol className="space-y-2 text-sm text-gray-400">
          ...
          <li>2. Envie qualquer mensagem — Sara vai responder via Gemini</li>
          <li>3. Na primeira mensagem, Sara pedirá o aceite LGPD</li>
